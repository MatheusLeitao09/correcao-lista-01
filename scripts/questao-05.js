...
let contadorArrayPrecosComDesconto = 0;
let preco = 0;
let desconto = 0;
...
precosComDesconto[contadorArrayPrecosComDesconto] = preco;
contadorArrayPrecosComDesconto++;
...
console.log(`A média dos valores com desconto é: R$: ${mediaDescontos}`);
